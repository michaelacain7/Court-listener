...
def check_high_impact_filings(seen):
    ...
    for item in data.get("results", [])[:10]:
        ...
        vip_plaintiffs = [
            ...
            "soros", "dalio", "thiel", "ellison", "gates", "cook", "nadella", "pichai",
            "altman", "chesky", "kalanick", "neumann", "bankman", "sbf",
            "pelosi", "warren", "desantis", "newsom", "paxton", "james",  # AGs & politicians
            "gensler", "chopra", "khan",  # SEC/CFPB/FTC chairs
        ]
