            ...
            if url.endswith('.pdf'):
                try:
                    ...
                    if pdf_resp.ok and len(pdf_resp.content) < 2000000:  # <2MB
                        ...
                        pages_text = []
                        # Extract first 8 pages (enough for background + ruling)
                    ...
                    log.warning(f"CAFC PDF extraction failed: {e}")
